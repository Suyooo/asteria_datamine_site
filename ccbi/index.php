...
<body>
    ...
    <div style="display:flex;width:100%">
        ...
        <div style="padding-left: 1em">
	        ...
	        This player does not use the original system, but instead presents the MA on a best-effort basis. Several things are unimplemented. Feel free to share screenshots of the funniest errors.<br>
